document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contentArea) {
        ...
        function addMessage(sender, text, isQuestion = false) {
        ...
        async function getAIResponse(userMessage) {
            ...
            showTypingIndicator();
            try {
                // NOTE: This fetch call requires a backend function (like Netlify Functions) named 'concierge'
        ...
        function showTypingIndicator() {
            ...
            const indicatorHTML = `<div class="message-wrapper concierge typing-indicator"><img src="${avatarUrl}" class="chat-avatar" alt="..."><div class="bubble"><span class="dot"></span><span class="dot"></span><span class="dot"></span></div></div>`;
            chatBody.insertAdjacentHTML('afterbegin', indicatorHTML);
        }
        ...
        function handleQuestion(question) {
            addMessage('concierge', question, true);
        ...
        function createEditableDraft(reviewText) {
            ...
            addMessage('concierge', 'Ви можете відредагувати текст. Коли будете готові, натисніть кнопку нижче.', true);
            createPostButtons();
        }
